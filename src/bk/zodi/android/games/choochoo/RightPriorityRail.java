...
public class RightPriorityRail extends Rail {
	public static final int RIGHT_PRIORITY_RAIL_UP = 0;
	public static final int RIGHT_PRIORITY_RAIL_LEFT = 1;
	public static final int RIGHT_PRIORITY_RAIL_DOWN = 2;
	public static final int RIGHT_PRIORITY_RAIL_RIGHT = 3;
	...
	public RightPriorityRail(float x, float y, int direction) {
		super(x, y, direction);
		// TODO Auto-generated constructor stub
		this.type = GameConstants.RAIL_RIGTH_PRIORITY;
	...
	public Guide getGuide(int enterDirect, int i) {
		// TODO Auto-generated method stub
		if (direction == RIGHT_PRIORITY_RAIL_UP) {
		...
		} else if (direction == RIGHT_PRIORITY_RAIL_LEFT) {
		...
		} else if (direction == RIGHT_PRIORITY_RAIL_DOWN) {
